...
export function PersistenceBanner({ paths }: Readonly<PersistenceBannerProps>) {
  ...
  return (
    <div className="relative w-full border-b border-red-200 bg-red-50">
        ...
        <div className="flex items-start gap-3 pr-10">
          ...
          <div className="min-w-0 space-y-2">
            <div className="flex flex-wrap items-baseline gap-x-2">
              <p className="text-sm font-semibold text-red-900">Possible persistence artifacts detected</p>
              <span className="text-[11px] uppercase tracking-[0.12em] text-red-700/70">Action recommended</span>
            </div>
            <p className="text-xs leading-relaxed text-red-900/80">
              Uninstalling packages may not remove these files. Review and delete them in source control if unintended.
            </p>
